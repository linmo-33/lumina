...
interface SetupStatus { configured: boolean; adminExists: boolean; canInitialize: boolean; checks: { database: boolean; authSecret: boolean; appUrl: boolean; emailApiKey: boolean; emailFrom: boolean; imageApiUrl: boolean; imageApiKey: boolean } }
const checks = [
  ...
  { key: "imageApiUrl" as const, label: "生图服务地址", description: "CHATGPT2API_BASE_URL", icon: Server },
  { key: "imageApiKey" as const, label: "生图服务密钥", description: "CHATGPT2API_KEY", icon: KeyRound },
];
