...
```bash
sqlite3 data/app.db "UPDATE user SET role='admin' WHERE email='你的邮箱';"
```
...
生图完全由 [chatgpt2api](https://github.com/basketikun/chatgpt2api) 负责，本项目只做用户、额度、历史与转发。
